package com.mobicom.s16.presas.shanette.mco.util

import com.mobicom.s16.presas.shanette.mco.R
...
object IconMapper {
    fun getIconResource(category: String): Int {
        return when (category.lowercase()) {
            ...
            else -> R.drawable.ic_launcher_background // fallback/default icon
        }
    }
}
